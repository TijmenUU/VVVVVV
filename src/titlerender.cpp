...
void updategraphicsmode() { swfStage = stage; }
...
void titlerender(Graphics & dwgfx, mapclass & map, Game & game, UtilityClass & help, musicclass & music)
{
	...
	else
	{
		...
		else if(game.currentmenuname == "levellist")
		{
			...
			if(tmp >= 0 && tmp < (int)ed.ListOfMetaData.size())
			{ // FIXME: size_t/int! -flibit
		...
		else if(game.currentmenuname == "controller")
		{
			...
			if(game.currentmenuoption == 1 || game.currentmenuoption == 2 || game.currentmenuoption == 3)
			{
				dwgfx.Print(-1,
				 85,
				 "Flip is bound to: " + std::string(UtilityClass::GCString(game.controllerButton_flip)),
				 tr,
				 tg,
				 tb,
				 true);
				dwgfx.Print(-1,
				 95,
				 "Enter is bound to: " + std::string(UtilityClass::GCString(game.controllerButton_map)),
				 tr,
				 tg,
				 tb,
				 true);
				dwgfx.Print(-1,
				 105,
				 "Menu is bound to: " + std::string(UtilityClass::GCString(game.controllerButton_esc)),
				 tr,
				 tg,
				 tb,
				 true);
		...
		else if(game.currentmenuname == "playerworlds")
		{
			...
			if(dwgfx.tempstring.length() > 80)
			{
				...
				dwgfx.Print(320 - ((dwgfx.tempstring.length() - 80) * 8),
				 190,
				 dwgfx.tempstring.substr(0, dwgfx.tempstring.length() - 80),
				 tr,
				 tg,
				 tb);
			...
			else if(dwgfx.tempstring.length() > 40)
			{
				...
				dwgfx.Print(320 - ((dwgfx.tempstring.length() - 40) * 8),
				 200,
				 dwgfx.tempstring.substr(0, dwgfx.tempstring.length() - 40),
				 tr,
				 tg,
				 tb);
				dwgfx.Print(0, 210, dwgfx.tempstring.substr(dwgfx.tempstring.length() - 40, 40), tr, tg, tb);
...
void gamecompleterender(Graphics & dwgfx, Game & game, UtilityClass & help, mapclass & map)
{
	...
	if(dwgfx.onscreen(290 + game.creditposition))
		dwgfx.bigprint(-1, 290 + game.creditposition, "Starring", tr, tg, tb, true, 2);
	...
	if(dwgfx.onscreen(520 + game.creditposition))
		dwgfx.bigprint(-1, 520 + game.creditposition, "Credits", tr, tg, tb, true, 3);
	...
	if(dwgfx.onscreen(870 + game.creditposition))
		dwgfx.bigprint(-1, 870 + game.creditposition, "Patrons", tr, tg, tb, true, 3);

	if(dwgfx.onscreen(910 + game.creditposition))
		dwgfx.Print(-1, 910 + game.creditposition, "Anders Ekermo", tr, tg, tb, true);
	if(dwgfx.onscreen(920 + game.creditposition))
		dwgfx.Print(-1, 920 + game.creditposition, "Andreas K|mper", tr, tg, tb, true);
	if(dwgfx.onscreen(930 + game.creditposition))
		dwgfx.Print(-1, 930 + game.creditposition, "Anthony Burch", tr, tg, tb, true);
	if(dwgfx.onscreen(940 + game.creditposition))
		dwgfx.Print(-1, 940 + game.creditposition, "Bennett Foddy", tr, tg, tb, true);
	if(dwgfx.onscreen(950 + game.creditposition))
		dwgfx.Print(-1, 950 + game.creditposition, "Brendan O'Sullivan", tr, tg, tb, true);
	if(dwgfx.onscreen(960 + game.creditposition))
		dwgfx.Print(-1, 960 + game.creditposition, "Christopher Armstrong", tr, tg, tb, true);
	if(dwgfx.onscreen(970 + game.creditposition))
		dwgfx.Print(-1, 970 + game.creditposition, "Daniel Benmergui", tr, tg, tb, true);
	if(dwgfx.onscreen(980 + game.creditposition))
		dwgfx.Print(-1, 980 + game.creditposition, "David Pittman", tr, tg, tb, true);
	if(dwgfx.onscreen(990 + game.creditposition))
		dwgfx.Print(-1, 990 + game.creditposition, "Ian Bogost", tr, tg, tb, true);
	if(dwgfx.onscreen(1000 + game.creditposition))
		dwgfx.Print(-1, 1000 + game.creditposition, "Jaz McDougall", tr, tg, tb, true);
	if(dwgfx.onscreen(1010 + game.creditposition))
		dwgfx.Print(-1, 1010 + game.creditposition, "John Faulkenbury", tr, tg, tb, true);
	if(dwgfx.onscreen(1020 + game.creditposition))
		dwgfx.Print(-1, 1020 + game.creditposition, "Jonathan Whiting", tr, tg, tb, true);
	if(dwgfx.onscreen(1030 + game.creditposition))
		dwgfx.Print(-1, 1030 + game.creditposition, "Kyle Pulver", tr, tg, tb, true);
	if(dwgfx.onscreen(1040 + game.creditposition))
		dwgfx.Print(-1, 1040 + game.creditposition, "Markus Persson", tr, tg, tb, true);
	if(dwgfx.onscreen(1050 + game.creditposition))
		dwgfx.Print(-1, 1050 + game.creditposition, "Nathan Ostgard", tr, tg, tb, true);
	if(dwgfx.onscreen(1060 + game.creditposition))
		dwgfx.Print(-1, 1060 + game.creditposition, "Nick Easler", tr, tg, tb, true);
	if(dwgfx.onscreen(1070 + game.creditposition))
		dwgfx.Print(-1, 1070 + game.creditposition, "Stephen Lavelle", tr, tg, tb, true);

	if(dwgfx.onscreen(1090 + game.creditposition))
		dwgfx.Print(-1, 1090 + game.creditposition, "and", tr, tg, tb, true);

	if(dwgfx.onscreen(1110 + game.creditposition))
		dwgfx.Print(-1, 1110 + game.creditposition, "Adam Wendt", tr, tg, tb, true);
	if(dwgfx.onscreen(1110 + game.creditposition))
		dwgfx.Print(-1, 1120 + game.creditposition, "Andreas J{rgensen", tr, tg, tb, true);
	if(dwgfx.onscreen(1120 + game.creditposition))
		dwgfx.Print(-1, 1130 + game.creditposition, "}ngel Louzao Penalva", tr, tg, tb, true);
	if(dwgfx.onscreen(1130 + game.creditposition))
		dwgfx.Print(-1, 1140 + game.creditposition, "Ashley Burton", tr, tg, tb, true);
	if(dwgfx.onscreen(1140 + game.creditposition))
		dwgfx.Print(-1, 1150 + game.creditposition, "Aubrey Hesselgren", tr, tg, tb, true);
	if(dwgfx.onscreen(1150 + game.creditposition))
		dwgfx.Print(-1, 1160 + game.creditposition, "Bradley Rose", tr, tg, tb, true);
	if(dwgfx.onscreen(1160 + game.creditposition))
		dwgfx.Print(-1, 1170 + game.creditposition, "Brendan Urquhart", tr, tg, tb, true);
	if(dwgfx.onscreen(1170 + game.creditposition))
		dwgfx.Print(-1, 1180 + game.creditposition, "Chris Ayotte", tr, tg, tb, true);
	if(dwgfx.onscreen(1180 + game.creditposition))
		dwgfx.Print(-1, 1190 + game.creditposition, "Christopher Zamanillo", tr, tg, tb, true);
	if(dwgfx.onscreen(1190 + game.creditposition))
		dwgfx.Print(-1, 1200 + game.creditposition, "Daniel Schuller", tr, tg, tb, true);
	if(dwgfx.onscreen(1200 + game.creditposition))
		dwgfx.Print(-1, 1210 + game.creditposition, "Hybrid Mind Studios", tr, tg, tb, true);
	if(dwgfx.onscreen(1210 + game.creditposition))
		dwgfx.Print(-1, 1220 + game.creditposition, "Emilie McGinley", tr, tg, tb, true);
	if(dwgfx.onscreen(1220 + game.creditposition))
		dwgfx.Print(-1, 1230 + game.creditposition, "Francisco Solares", tr, tg, tb, true);
	if(dwgfx.onscreen(1230 + game.creditposition))
		dwgfx.Print(-1, 1240 + game.creditposition, "Hal Helms", tr, tg, tb, true);
	if(dwgfx.onscreen(1240 + game.creditposition))
		dwgfx.Print(-1, 1250 + game.creditposition, "Hayden Scott-Baron", tr, tg, tb, true);
	if(dwgfx.onscreen(1250 + game.creditposition))
		dwgfx.Print(-1, 1260 + game.creditposition, "Hermit Games", tr, tg, tb, true);
	if(dwgfx.onscreen(1260 + game.creditposition))
		dwgfx.Print(-1, 1270 + game.creditposition, "Ido Yehieli", tr, tg, tb, true);
	if(dwgfx.onscreen(1270 + game.creditposition))
		dwgfx.Print(-1, 1280 + game.creditposition, "Jade Vault Games", tr, tg, tb, true);
	if(dwgfx.onscreen(1280 + game.creditposition))
		dwgfx.Print(-1, 1290 + game.creditposition, "James Andrews", tr, tg, tb, true);
	if(dwgfx.onscreen(1290 + game.creditposition))
		dwgfx.Print(-1, 1300 + game.creditposition, "James Riley", tr, tg, tb, true);
	if(dwgfx.onscreen(1300 + game.creditposition))
		dwgfx.Print(-1, 1310 + game.creditposition, "James Hsieh", tr, tg, tb, true);
	if(dwgfx.onscreen(1310 + game.creditposition))
		dwgfx.Print(-1, 1320 + game.creditposition, "Jasper Byrne", tr, tg, tb, true);
	if(dwgfx.onscreen(1320 + game.creditposition))
		dwgfx.Print(-1, 1330 + game.creditposition, "Jedediah Baker", tr, tg, tb, true);
	if(dwgfx.onscreen(1330 + game.creditposition))
		dwgfx.Print(-1, 1340 + game.creditposition, "Jens Bergensten", tr, tg, tb, true);
	if(dwgfx.onscreen(1340 + game.creditposition))
		dwgfx.Print(-1, 1350 + game.creditposition, "Jeremy J. Penner", tr, tg, tb, true);
	if(dwgfx.onscreen(1350 + game.creditposition))
		dwgfx.Print(-1, 1360 + game.creditposition, "Jeremy Peterson", tr, tg, tb, true);
	if(dwgfx.onscreen(1360 + game.creditposition))
		dwgfx.Print(-1, 1370 + game.creditposition, "Jim McGinley", tr, tg, tb, true);
	if(dwgfx.onscreen(1370 + game.creditposition))
		dwgfx.Print(-1, 1380 + game.creditposition, "Jonathan Cartwright", tr, tg, tb, true);
	if(dwgfx.onscreen(1380 + game.creditposition))
		dwgfx.Print(-1, 1390 + game.creditposition, "John Nesky", tr, tg, tb, true);
	if(dwgfx.onscreen(1390 + game.creditposition))
		dwgfx.Print(-1, 1400 + game.creditposition, "Jos Yule", tr, tg, tb, true);
	if(dwgfx.onscreen(1400 + game.creditposition))
		dwgfx.Print(-1, 1410 + game.creditposition, "Jose Flores", tr, tg, tb, true);
	if(dwgfx.onscreen(1410 + game.creditposition))
		dwgfx.Print(-1, 1420 + game.creditposition, "Josh Bizeau", tr, tg, tb, true);
	if(dwgfx.onscreen(1420 + game.creditposition))
		dwgfx.Print(-1, 1430 + game.creditposition, "Joshua Buergel", tr, tg, tb, true);
	if(dwgfx.onscreen(1430 + game.creditposition))
		dwgfx.Print(-1, 1440 + game.creditposition, "Joshua Hochner", tr, tg, tb, true);
	if(dwgfx.onscreen(1440 + game.creditposition))
		dwgfx.Print(-1, 1450 + game.creditposition, "Kurt Ostfeld", tr, tg, tb, true);
	if(dwgfx.onscreen(1450 + game.creditposition))
		dwgfx.Print(-1, 1460 + game.creditposition, "Magnus P~lsson", tr, tg, tb, true);
	if(dwgfx.onscreen(1460 + game.creditposition))
		dwgfx.Print(-1, 1470 + game.creditposition, "Mark Neschadimenko", tr, tg, tb, true);
	if(dwgfx.onscreen(1470 + game.creditposition))
		dwgfx.Print(-1, 1480 + game.creditposition, "Matt Antonellis", tr, tg, tb, true);
	if(dwgfx.onscreen(1480 + game.creditposition))
		dwgfx.Print(-1, 1490 + game.creditposition, "Matthew Reppert", tr, tg, tb, true);
	if(dwgfx.onscreen(1490 + game.creditposition))
		dwgfx.Print(-1, 1500 + game.creditposition, "Michael Falkensteiner", tr, tg, tb, true);
	if(dwgfx.onscreen(1500 + game.creditposition))
		dwgfx.Print(-1, 1510 + game.creditposition, "Michael Vendittelli", tr, tg, tb, true);
	if(dwgfx.onscreen(1510 + game.creditposition))
		dwgfx.Print(-1, 1520 + game.creditposition, "Mike Kasprzak", tr, tg, tb, true);
	if(dwgfx.onscreen(1520 + game.creditposition))
		dwgfx.Print(-1, 1530 + game.creditposition, "Mitchel Stein", tr, tg, tb, true);
	if(dwgfx.onscreen(1530 + game.creditposition))
		dwgfx.Print(-1, 1540 + game.creditposition, "Sean Murray", tr, tg, tb, true);
	if(dwgfx.onscreen(1540 + game.creditposition))
		dwgfx.Print(-1, 1550 + game.creditposition, "Simon Michael", tr, tg, tb, true);
	if(dwgfx.onscreen(1550 + game.creditposition))
		dwgfx.Print(-1, 1560 + game.creditposition, "Simon Schmid", tr, tg, tb, true);
	if(dwgfx.onscreen(1560 + game.creditposition))
		dwgfx.Print(-1, 1570 + game.creditposition, "Stephen Maxwell", tr, tg, tb, true);
	if(dwgfx.onscreen(1570 + game.creditposition))
		dwgfx.Print(-1, 1580 + game.creditposition, "Swing Swing Submarine", tr, tg, tb, true);
	if(dwgfx.onscreen(1580 + game.creditposition))
		dwgfx.Print(-1, 1590 + game.creditposition, "Tam Toucan", tr, tg, tb, true);
	if(dwgfx.onscreen(1590 + game.creditposition))
		dwgfx.Print(-1, 1600 + game.creditposition, "Terry Dooher", tr, tg, tb, true);
	if(dwgfx.onscreen(1600 + game.creditposition))
		dwgfx.Print(-1, 1610 + game.creditposition, "Tim W.", tr, tg, tb, true);
	if(dwgfx.onscreen(1610 + game.creditposition))
		dwgfx.Print(-1, 1620 + game.creditposition, "Timothy Bragan", tr, tg, tb, true);

	if(dwgfx.onscreen(1760 + game.creditposition))
		dwgfx.bigprint(-1, 1760 + game.creditposition, "Thanks for playing!", tr, tg, tb, true, 2);
...
void gamerender(Graphics & dwgfx, mapclass & map, Game & game, entityclass & obj, UtilityClass & help)
{
	...
	if(game.readytotele > 100 && !game.advancetext && game.hascontrol && !script.running && !game.intimetrial)
	{
		if(dwgfx.flipmode)
		{
			dwgfx.bprint(5,
			 ...
			 game.readytotele - 20 - (help.glow / 2),
			 game.readytotele - 20 - (help.glow / 2),
			 game.readytotele,
			 true);
		}
	...
	if(game.swnmode)
	{
		...
		else if(game.swngame == 1)
		{
			if(game.swnmessage == 0)
			{
				...
				dwgfx
				 .bigprint(25, 24, tempstring, 220 - (help.glow), 220 - (help.glow), 255 - (help.glow / 2), false, 2);
				tempstring = help.timestring(game.swnrecord);
				dwgfx.Print(240, 10, "Best Time", 220 - (help.glow), 220 - (help.glow), 255 - (help.glow / 2), false);
				dwgfx
				 .bigrprint(300, 24, tempstring, 220 - (help.glow), 220 - (help.glow), 255 - (help.glow / 2), false, 2);
			...
			else if(game.swnmessage == 1)
			{
				...
				{
					dwgfx
					 .Print(240, 10, "Best Time", 220 - (help.glow), 220 - (help.glow), 255 - (help.glow / 2), false);
					dwgfx.bigrprint(300,
					 24,
					 tempstring,
					 128 - (help.glow),
		...
		else if(game.swngame == 7)
		{
			if(game.swndelay >= 60)
			{
				...
				dwgfx
				 .bigrprint(300, 205, tempstring, 220 - (help.glow), 220 - (help.glow), 255 - (help.glow / 2), true, 2);
			}
	...
	if(game.intimetrial && dwgfx.fademode == 0)
	{
		...
		if(game.timetrialcountdown > 0)
		{
			if(game.timetrialcountdown < 30)
			{
				...
				if(int(game.timetrialcountdown / 4) % 2 == 0)
					dwgfx
					 .bigprint(-1, 100, "Go!", 220 - (help.glow), 220 - (help.glow), 255 - (help.glow / 2), true, 4);
			}
		...
		else
		{
			...
			if(game.trinkets < game.timetrialshinytarget)
			{
				dwgfx.bprint(56,
				 42,
				 help.String(game.trinkets) + " of " + help.String(game.timetrialshinytarget),
				 196,
				 80,
				 80);
			}
	...
	if(game.activeactivity > -1)
	{
		...
		dwgfx.drawtextbox(16,
		 4,
		 36,
		 3,
		 game.activity_r * (game.act_fade / 10.0f),
		 game.activity_g * (game.act_fade / 10.0f),
		 game.activity_b * (game.act_fade / 10.0f));
		dwgfx.Print(5,
		 12,
...
void maprender(Graphics & dwgfx, Game & game, mapclass & map, entityclass & obj, UtilityClass & help)
{
	...
	switch(game.menupage)
	{
		case 0:
			...
			{
				//draw the map image
				dwgfx.drawcustompixeltextbox(35 + map.custommmxoff,
				 16 + map.custommmyoff,
				...
				if(map.customzoom == 4)
				{
					if(map.cursorstate == 1)
					{
						...
						{
							dwgfx.drawrect(40 + ((game.roomx - 100) * 48) + map.custommmxoff,
							 21 + ((game.roomy - 100) * 36) + map.custommmyoff,
							 48,
							 36,
							 255,
							 255,
							 255);
							dwgfx.drawrect(40 + ((game.roomx - 100) * 48) + 2 + map.custommmxoff,
							 21 + ((game.roomy - 100) * 36) + 2 + map.custommmyoff,
							 48 - 4,
							 36 - 4,
							 255,
							 255,
				...
				else if(map.customzoom == 2)
				{
					if(map.cursorstate == 1)
					{
						if(int(map.cursordelay / 4) % 2 == 0)
						{
							dwgfx.drawrect(40 + ((game.roomx - 100) * 24) + map.custommmxoff,
							 21 + ((game.roomy - 100) * 18) + map.custommmyoff,
							 24,
							 18,
							 255,
							 255,
							 255);
							dwgfx.drawrect(40 + ((game.roomx - 100) * 24) + 2 + map.custommmxoff,
							 21 + ((game.roomy - 100) * 18) + 2 + map.custommmyoff,
							 24 - 4,
							 18 - 4,
							 255,
							 255,
				...
				else
				{
					if(map.cursorstate == 1)
					{
						if(int(map.cursordelay / 4) % 2 == 0)
						{
							dwgfx.drawrect(40 + ((game.roomx - 100) * 12) + map.custommmxoff,
							 21 + ((game.roomy - 100) * 9) + map.custommmyoff,
							 12,
							 9,
							 255,
							 255,
							 255);
							dwgfx.drawrect(40 + ((game.roomx - 100) * 12) + 2 + map.custommmxoff,
							 21 + ((game.roomy - 100) * 9) + 2 + map.custommmyoff,
							 12 - 4,
							 9 - 4,
							 255,
							 255,
			...
			else
			{
				...
				if(game.roomx == 109)
				{
					...
					else if(map.cursorstate == 2)
					{
						...
						if(int(map.cursordelay / 15) % 2 == 0)
						{
							dwgfx.drawrect(40 + ((game.roomx - 100) * 12) + 2,
							 21 + 2,
							 12 - 4,
							 180 - 4,
							 16,
				...
				else
				{
					...
					else if(map.cursorstate == 1)
					{
						...
						if(int(map.cursordelay / 4) % 2 == 0)
						{
							dwgfx.drawrect(40 + ((game.roomx - 100) * 12),
							 21 + ((game.roomy - 100) * 9),
							 12,
							 9,
							 255,
				...
				if(map.showtrinkets)
				{
					for(int i = 0; i < map.numshinytrinkets; i++)
					{
						if(obj.collect[i] == 0)
						{
							...
							if(dwgfx.flipmode)
								temp += 3;
							dwgfx.drawtile(40 + 3 + (map.shinytrinkets[i].x * 12),
		...
		case 1:
			...
			else if(map.custommode)
			{
				...
				if(dwgfx.flipmode)
				{
					...
					dwgfx.Print(-1,
					 220 - 70,
					 "by " + ed.ListOfMetaData[game.playcustomlevel].creator,
					 196,
					 196,
					 255 - help.glow,
					 true);
					dwgfx.Print(-1,
					 220 - 80,
					 ed.ListOfMetaData[game.playcustomlevel].website,
					 196,
					 196,
					 255 - help.glow,
					 true);
					dwgfx.Print(-1,
					 220 - 100,
					 ed.ListOfMetaData[game.playcustomlevel].Desc1,
					 196,
					 196,
					 255 - help.glow,
					 true);
					dwgfx.Print(-1,
					 220 - 110,
					 ed.ListOfMetaData[game.playcustomlevel].Desc2,
					 196,
					 196,
					 255 - help.glow,
					 true);
					dwgfx.Print(-1,
					 220 - 120,
					 ed.ListOfMetaData[game.playcustomlevel].Desc3,
					 196,
					 196,
					 255 - help.glow,
					 true);
					...
					if(map.customcrewmates - game.crewmates == 1)
					{
						dwgfx.Print(1,
						 220 - 165,
						 help.number(int(map.customcrewmates - game.crewmates)) + " crewmate remains",
						 196,
						 196,
						 255 - help.glow,
						 true);
				...
				{
					dwgfx
					 .bigprint(-1, 45, ed.ListOfMetaData[game.playcustomlevel].title, 196, 196, 255 - help.glow, true);
					dwgfx.Print(-1,
					 70,
					 "by " + ed.ListOfMetaData[game.playcustomlevel].creator,
					 196,
					 ...
					 true);
					dwgfx
					 .Print(-1, 80, ed.ListOfMetaData[game.playcustomlevel].website, 196, 196, 255 - help.glow, true);
					dwgfx
					 .Print(-1, 100, ed.ListOfMetaData[game.playcustomlevel].Desc1, 196, 196, 255 - help.glow, true);
					dwgfx
					 .Print(-1, 110, ed.ListOfMetaData[game.playcustomlevel].Desc2, 196, 196, 255 - help.glow, true);
					dwgfx
					 .Print(-1, 120, ed.ListOfMetaData[game.playcustomlevel].Desc3, 196, 196, 255 - help.glow, true);
		...
		case 2:
			...
			if(map.custommode)
			{
				if(dwgfx.flipmode)
				{
					...
					dwgfx.Print(0,
					 152,
					 help.number(game.trinkets) + " out of " + help.number(map.customtrinkets),
					 96,
					 96,
					 96,
					 true);
		...
		case 3:
			...
			else if(map.custommode)
			{
				if(game.gamesaved)
				{
					...
					{
						dwgfx
						 .Print(0, 122, game.customleveltitle, 25, 255 - (help.glow / 2), 255 - (help.glow / 2), true);
						dwgfx.Print(160 - 84,
						 78,
						 game.savetime,
						 255 - (help.glow / 2),
					...
					{
						dwgfx
						 .Print(0, 90, game.customleveltitle, 25, 255 - (help.glow / 2), 255 - (help.glow / 2), true);
						dwgfx.Print(160 - 84,
						 132,
						 game.savetime,
						 255 - (help.glow / 2),
				...
				else
				{
					...
					if(game.quicksummary != "")
					{
						if(dwgfx.flipmode)
						{
							...
							dwgfx
							 .Print(0, 100, game.quicksummary, 164 - (help.glow / 4), 164 - (help.glow / 4), 164, true);
						}
						else
						{
							dwgfx.Print(0, 100, "Last Save:", 164 - (help.glow / 4), 164 - (help.glow / 4), 164, true);
							dwgfx
							 .Print(0, 110, game.quicksummary, 164 - (help.glow / 4), 164 - (help.glow / 4), 164, true);
						}
					}
				}
			}
...
void teleporterrender(Graphics & dwgfx, Game & game, mapclass & map, entityclass & obj, UtilityClass & help)
{
	...
	if(game.useteleporter)
	{
		...
		dwgfx.Print(5,
		 ...
		 true);
		dwgfx
		 .Print(5, 225, "Press ENTER to Teleport", 220 - (help.glow), 220 - (help.glow), 255 - (help.glow / 2), true);
	}
