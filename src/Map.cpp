...
int mapclass::RGB(int red, int green, int blue) { return (blue | (green << 8) | (red << 16)); }

int mapclass::intpol(int a, int b, float c) { return static_cast<int>(a + ((b - a) * c)); }
					...
					switch(edentity[edi].t)
					{
						case 1: //Enemies
							...
							obj.createentity(game,
							 (edentity[edi].x * 8) - ((rx - 100) * 40 * 8),
							 (edentity[edi].y * 8) - ((ry - 100) * 30 * 8),
							 56,
							 edentity[edi].p1,
							 4,
							 bx1,
						...
						case 2: //Platforms and Threadmills
							if(edentity[edi].p1 <= 4)
							{
								...
								obj.createentity(game,
								 ...
								 2,
								 edentity[edi].p1,
								 ed.level[rx - 100 + ((ry - 100) * ed.mapwidth)].platv,
								 bx1,
								 by1,
								 bx2,
								 by2);
						...
						case 11: //Gravity Lines
							...
							{ //Horizontal
								obj.createentity(game,
								 (edentity[edi].p2 * 8),
								 (edentity[edi].y * 8) - ((ry - 100) * 30 * 8) + 4,
								 11,
								 edentity[edi].p3);
							}
							else
							{ //Vertical
								obj.createentity(game,
								 (edentity[edi].x * 8) - ((rx - 100) * 40 * 8) + 3,
								 (edentity[edi].p2 * 8),
								 12,
								 edentity[edi].p3);
							}
						...
						case 15: //Collectable crewmate
							obj.createentity(game,
							 ...
							 (edentity[edi].y * 8) - ((ry - 100) * 30 * 8) + 1,
							 55,
							 ed.findcrewmate(edi),
							 edentity[edi].p1,
							 edentity[edi].p2);
						...
						case 18: //Terminals
							...
							obj.createentity(game,
							 (edentity[edi].x * 8) - ((rx - 100) * 40 * 8),
							 (edentity[edi].y * 8) - ((ry - 100) * 30 * 8) + 8,
							 20,
							 1);
							obj.createblock(5,
							 (edentity[edi].x * 8) - ((rx - 100) * 40 * 8) - 8,
							 (edentity[edi].y * 8) - ((ry - 100) * 30 * 8) + 8,
							 20,
							 16,
							 35);
						...
						case 50: //Warp Lines
							...
							else if(edentity[edi].p1 == 2)
							{ //Vertical, top
								obj.createentity(game,
								 (edentity[edi].p2 * 8),
								 (edentity[edi].y * 8) - ((ry - 100) * 30 * 8) + 7,
								 53,
								 edentity[edi].p3);
							}
