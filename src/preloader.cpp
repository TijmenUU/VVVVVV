...
void preloaderrender(Graphics & dwgfx, Game & game, UtilityClass & help)
{
	...
	if(pre_transition >= 30)
	{
		...
		FillRect(dwgfx.backBuffer,
		 ...
		 pre_frontrectw,
		 pre_frontrecth,
		 dwgfx.getBGR(0x3E, 0x31, 0xA2));

		if(pre_fakepercent == 100)
		{
			dwgfx
			 .Print(282 - (15 * 8), 204, "LOADING... " + help.String(int(pre_fakepercent)) + "%", 124, 112, 218, false);
		}
		else
		{
			dwgfx
			 .Print(282 - (14 * 8), 204, "LOADING... " + help.String(int(pre_fakepercent)) + "%", 124, 112, 218, false);
		}
