...
std::vector<std::string> finalclass::loadlevel(int rx, int ry, Game & game, entityclass & obj)
{
	...
	switch(t)
	{
		...
		case rn(110, 104):
			...
			if(!game.intimetrial)
			{
				if(game.companion == 0 && obj.flags[8] == 0
				 && !game.crewstats[3]) //also need to check if he's rescued in a previous game
				{
		...
		case rn(52, 56):
			...
			tmap.push_back(
			 "219,218,98,220,259,259,259,259,259,259,259,259,259,259,259,259,259,259,259,259,259,259,259,259,259,259,259,259,259,259,259,259,259,259,259,260,218,98,220,219");
			tmap.push_back(
