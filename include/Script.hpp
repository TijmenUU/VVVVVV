...
public:
	...
	void startgamemode(int t, Graphics & dwgfx, Game & game, mapclass & map, entityclass & obj, musicclass & music);

	void teleport(Graphics & dwgfx, Game & game, mapclass & map, entityclass & obj, musicclass & music);
